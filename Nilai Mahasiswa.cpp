#include <iostream> /*Fahmi Fahqur Rozi*/
#include <sstream> /*20051397060*/
...
int main(int argc, char *argv[])
{
    ...
    cout << endl << "Kategori Nilai" << endl << k << endl << endl;
	...
	cout << endl << k << endl;
	cout << "Nilai Maksimum : " << nilai_maksimal << endl;
	cout << "Oleh : " << namap << endl << k << endl;
